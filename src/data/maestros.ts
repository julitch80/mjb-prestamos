...
// ── Usuarios ──────────────────────────────────────────────────────────────────
//
// SEGURIDAD — por qué `correo` está vacío aquí y de dónde se rellena:
// Este archivo se empaqueta tal cual en el bundle de JavaScript que sirve
// GitHub Pages. Antes traía el correo institucional de los 46 docentes en
// texto plano, así que cualquiera (sin sesión) podía descargar el bundle
// público y extraer la lista completa — lista lista para usar en suplantación
// de correo contra el claustro. Por eso el campo se vacía a propósito: el
// TIPO se conserva (`correo: string`), pero el VALOR no viaja en el bundle.
// Se rellena en tiempo de ejecución, DESPUÉS de que el usuario inicia sesión
// con su cuenta de Google institucional, con los datos reales de Firestore
// (colección `users`) vía `aplicarPlantillaFirestore` en `plantilla.ts`,
// invocada desde `authStore.ts` (`initAuthGoogle`). Firestore ya exige sesión
// para leer esa colección, así que el correo deja de estar expuesto sin auth.
// NO restaurar estos valores a mano: volvería a exponerlos en el bundle.
export const USUARIOS: Usuario[] = [
  // Directivos
  { id: 'rectora',      nombre: 'Nancy Adriana Herrera López',    nombreCorto: 'Nancy',      rol: 'rectora',     jornada: 'ambas',  correo: '',            color: '#e8c84a' },
  { id: 'coord_manana', nombre: 'Janneth Astrid Ocampo Carvajal', nombreCorto: 'Janneth',    rol: 'coordinador', jornada: 'manana', correo: '', color: '#f08080' },
  { id: 'coord_tarde',  nombre: 'Juan Diego Salazar Rendón',      nombreCorto: 'Juan Diego', rol: 'coordinador', jornada: 'tarde',  correo: '',   color: '#f08080' },

  // Docentes mañana — paleta arcoíris de 15 colores equidistantes (~24° entre sí)
  { id: 'johana',    nombre: 'Leidy Johana Cano Ruiz',          nombreCorto: 'Johana',     rol: 'docente', jornada: 'manana', correo: '',     color: '#ef4444' }, // red-500
  { id: 'beatriz',   nombre: 'Beatriz Elena Montoya Valdés',    nombreCorto: 'Beatriz',    rol: 'docente', jornada: 'manana', correo: '', color: '#f97316' }, // orange-500
  { id: 'adolfo',    nombre: 'Adolfo León Arango Arroyave',     nombreCorto: 'Adolfo',     rol: 'docente', jornada: 'manana', correo: '',   color: '#eab308' }, // yellow-500
  { id: 'gloria_a',  nombre: 'Gloria Estella Álvarez López',    nombreCorto: 'Gloria A.',  rol: 'docente', jornada: 'manana', correo: '',  color: '#84cc16' }, // lime-500
  { id: 'doris',     nombre: 'Doris Castrillón Álvarez',        nombreCorto: 'Doris',      rol: 'docente', jornada: 'manana', correo: '', color: '#22c55e' }, // green-500
  { id: 'marta',     nombre: 'Marta Úsuga',                     nombreCorto: 'Marta',      rol: 'docente', jornada: 'ambas',  correo: '',    color: '#10b981' }, // emerald-500
  { id: 'julian',    nombre: 'Julián David Medina Tamayo',      nombreCorto: 'Julián',     rol: 'docente', jornada: 'manana', correo: '',   color: '#14b8a6' }, // teal-500
  { id: 'carlos',    nombre: 'Carlos Cárdenas',                 nombreCorto: 'Carlos',     rol: 'docente', jornada: 'manana', correo: '', color: '#0ea5e9' }, // sky-500
  { id: 'yoguis',    nombre: 'Juan Carlos Blandón Vargas',      nombreCorto: 'Yoguis',     rol: 'docente', jornada: 'ambas',  correo: '',    color: '#3b82f6' }, // blue-500
  { id: 'jorge',     nombre: 'Jorge Iván Acevedo Tabares',      nombreCorto: 'Jorge',      rol: 'docente', jornada: 'manana', correo: '',   color: '#6366f1' }, // indigo-500
  { id: 'ledis',     nombre: 'Ledis Laura Quintana Seguanes',   nombreCorto: 'Ledis',      rol: 'docente', jornada: 'manana', correo: '',  color: '#8b5cf6' }, // violet-500
  { id: 'uriel',     nombre: 'José Uriel López Arias',          nombreCorto: 'Uriel',      rol: 'docente', jornada: 'manana', correo: '',     color: '#a855f7' }, // purple-500
  { id: 'claudia',   nombre: 'Claudia Patricia Henao Bermúdez', nombreCorto: 'Claudia',    rol: 'docente', jornada: 'manana', correo: '',   color: '#d946ef' }, // fuchsia-500
  { id: 'margara',   nombre: 'Margarita María Montoya Olaya',   nombreCorto: 'Margarita',  rol: 'docente', jornada: 'manana', correo: '', color: '#ec4899' }, // pink-500
  { id: 'monica_c',  nombre: 'Mónica Tatiana Córdoba Zapata',   nombreCorto: 'Mónica C.',  rol: 'docente', jornada: 'ambas',  correo: '',  color: '#f43f5e' }, // rose-500

  // Docentes tarde — paleta independiente
  { id: 'edgar',       nombre: 'Edgar Alexis Pérez Jaramillo',     nombreCorto: 'Edgar',       rol: 'docente', jornada: 'ambas', correo: '',    color: '#94a3b8' }, // slate
  { id: 'carolina',    nombre: 'Carolina Medina',                   nombreCorto: 'Carolina',    rol: 'docente', jornada: 'tarde', correo: '', color: '#f97316' }, // orange-dark
  { id: 'monica_rave', nombre: 'Mónica Alexandra Rave Velásquez',   nombreCorto: 'Mónica R.',   rol: 'docente', jornada: 'tarde', correo: '',    color: '#f472b6' }, // pink
  { id: 'fredy_g',     nombre: 'Fredy Gutiérrez',                   nombreCorto: 'Fredy G.',    rol: 'docente', jornada: 'tarde', correo: '', color: '#4ade80' }, // green
  { id: 'fredy_garcia',nombre: 'John Fredy García Arrubla',         nombreCorto: 'Fredy García',rol: 'docente', jornada: 'tarde', correo: '',    color: '#bef264' }, // lime-light
  { id: 'luis_javier', nombre: 'Luis Javier Rojas',                 nombreCorto: 'Luis Javier', rol: 'docente', jornada: 'tarde', correo: '',               color: '#2dd4bf' }, // teal
  { id: 'marina',      nombre: 'Luz Marina Zapata Vásquez',         nombreCorto: 'Marina',      rol: 'docente', jornada: 'tarde', correo: '',      color: '#fb7185' }, // rose
  { id: 'luis_angel',  nombre: 'Luis Ángel Quiceno',                nombreCorto: 'Luis Ángel',  rol: 'docente', jornada: 'tarde', correo: '',   color: '#a78bfa' }, // violet
  { id: 'juan_pablo',  nombre: 'Juan Pablo Bettin Tapia',           nombreCorto: 'Juan Pablo',  rol: 'docente', jornada: 'tarde', correo: '',    color: '#facc15' }, // yellow
  { id: 'hugo',        nombre: 'Hugo Armando Yepes Franco',         nombreCorto: 'Hugo',        rol: 'docente', jornada: 'tarde', correo: '',      color: '#fca5a5' }, // red-light
  { id: 'felipe',      nombre: 'Felipe Piedrahita Nieto',           nombreCorto: 'Felipe',      rol: 'docente', jornada: 'tarde', correo: '', color: '#fdba74' }, // peach
  { id: 'valentina',   nombre: 'Valentina Jaramillo López',         nombreCorto: 'Valentina',   rol: 'docente', jornada: 'tarde', correo: '', color: '#67e8f9' }, // cyan-light
  { id: 'yanet',       nombre: 'Yanet María Moscote Marulanda',     nombreCorto: 'Yanet',       rol: 'docente', jornada: 'tarde', correo: '',   color: '#86efac' }, // green-light
  { id: 'harol',       nombre: 'Harol Gómez',                       nombreCorto: 'Harol',       rol: 'docente', jornada: 'tarde', correo: '',     color: '#e879f9' }, // fuchsia

  // Nuevos docentes
  { id: 'yuri',       nombre: 'Yuri Catalina Gómez Gómez',        nombreCorto: 'Yuri',       rol: 'docente', jornada: 'ambas', correo: '',       color: '#c4b5fd' },
  { id: 'alexander',  nombre: 'Jhon Alexander Sánchez Giraldo',   nombreCorto: 'Alexander',  rol: 'docente', jornada: 'ambas', correo: '', color: '#fda4af' },
  ...
  { id: 'gri_leidy_a',   nombre: 'Leidy Yadira Atehortúa Rojas',      nombreCorto: 'Leidy A.',   rol: 'docente', jornada: 'manana', correo: '',   color: '#7dd3fc', sede: 'gustavo_rodas' },
  { id: 'gri_maria_v',   nombre: 'María Victoria Henao Toro',         nombreCorto: 'María V.',   rol: 'docente', jornada: 'manana', correo: '',       color: '#86efac', sede: 'gustavo_rodas' },
  { id: 'gri_lourdes',   nombre: 'Lourdes Uparela Imbeth',            nombreCorto: 'Lourdes',    rol: 'docente', jornada: 'manana', correo: '',   color: '#fcd34d', sede: 'gustavo_rodas' },
  { id: 'gri_edison',    nombre: 'Edison Alejandro Sánchez',          nombreCorto: 'Edison',     rol: 'docente', jornada: 'manana', correo: '',    color: '#c4b5fd', sede: 'gustavo_rodas' },
  { id: 'gri_jaqueline', nombre: 'Jaqueline Arévalo Alzate',          nombreCorto: 'Jaqueline',  rol: 'docente', jornada: 'manana', correo: '', color: '#f9a8d4', sede: 'gustavo_rodas' },
  // TARDE — cada docente dicta una o dos asignaturas en todos los grupos.
  { id: 'gri_sandra',    nombre: 'Sandra Milena García García',       nombreCorto: 'Sandra',     rol: 'docente', jornada: 'tarde',  correo: '',     color: '#fdba74', sede: 'gustavo_rodas' },
  { id: 'gri_johana_r',  nombre: 'Johana Rivera',                     nombreCorto: 'Johana R.',  rol: 'docente', jornada: 'tarde',  correo: '',     color: '#5eead4', sede: 'gustavo_rodas' },
  { id: 'gri_edwin',     nombre: 'Edwin Alexis Toro Dávila',          nombreCorto: 'Edwin',      rol: 'docente', jornada: 'tarde',  correo: '',        color: '#a3e635', sede: 'gustavo_rodas' },
  { id: 'gri_leonardo',  nombre: 'Leonardo Acevedo Suárez',           nombreCorto: 'Leonardo',   rol: 'docente', jornada: 'tarde',  correo: '',  color: '#93c5fd', sede: 'gustavo_rodas' },
