...
export const AGENDAS: AgendaSemanal[] = [
  ...
  },
  {
    ...
    hasta: '2026-09-18',
    publicadaPor: 'Equipo Técnico Institucional',
    notaFinal: 'La agenda de profesionales (orientación escolar y Escuela Entorno Protector, programa UAI y tutoras PTA) viene dentro del mismo documento, y aquí está repartida día por día.',
    dias: [
      {
        fecha: '2026-09-14',
        dia: 'lunes',
        notas: [
          'COMUNA PEDAGÓGICA de docentes sindicalizados en ADIDA y ASDEM: hay novedades en los horarios de clase. Ver en la página web.',
          'Los docentes reportan a coordinación el formato de resultados de los planes de apoyo del SEGUNDO periodo, y conservan las evidencias.',
          'Se habilita la plataforma Máster para el ingreso de los resultados de recuperación del segundo periodo.',
        ],
        actividades: [
          {
            hora: '8:00 am a 4:00 pm',
            actividad: 'Capacitación del programa de prejubilados',
            asisten: 'Margarita Montoya, Adolfo Arango, Doris Castrillón y Nancy Herrera',
            lugar: 'Parque El Salado',
            responsables: 'SED',
          },
          {
            hora: '9:00 am a 10:00 am',
            actividad: 'Charla sobre comunicación asertiva',
            asisten: 'Estudiantes del grupo 11°2 y su docente',
            lugar: 'Aula de clase',
            responsables: 'Profesional de PEEP',
          },
          {
            hora: '7:00 am',
            actividad: 'Apoyo en aula: 1°2',
            asisten: 'Milena Badel y Ebigildo Chanapicama',
            lugar: 'Sede Gustavo Rodas',
            responsables: 'Programa UAI',
          },
          {
            hora: 'Jornada A.M.',
            actividad: 'Revisión de estudiantes reportados en comisión de evaluación',
            asisten: 'Estudiantes citados',
            lugar: 'Sede Gustavo Rodas',
            responsables: 'Alexander Sánchez G.',
          },
        ],
      },
      {
        fecha: '2026-09-15',
        dia: 'martes',
        notas: ['Publicación de los estudiantes nuevos admitidos a grado transición para el año 2027.'],
        actividades: [
          {
            hora: '7:50 am a 11:30 am',
            actividad: 'Programa de higiene bucal: aplicación de flúor, en el orden 1º1, 1º2, 2º1 y 2º2',
            asisten: 'Grupos 1º1, 1º2, 2º1 y 2º2',
            lugar: 'Aulas de clase y cancha, sede Gustavo Rodas',
            responsables: 'Medellín te quiere saludable',
          },
          {
            hora: '9:00 am a 3:00 pm',
            actividad: 'Acompañamiento a docentes en centros de interés',
            asisten: 'Docentes y estudiantes',
            lugar: 'Sede principal',
            responsables: 'Yuri Catalina Gómez, tutora PTA',
          },
          {
            hora: '10:00 am a 4:00 pm',
            actividad: 'Acompañamiento en aula y programa de inspiración COMFAMA',
            asisten: 'Docentes, estudiantes y COMFAMA',
            lugar: 'Sede Gustavo Rodas',
            responsables: 'Beatriz Marín M., tutora PTA',
          },
          {
            hora: '11:00 am a 12:00 m',
            actividad: 'Revisión del plan de convivencia',
            asisten: 'Natalia Rivas',
            lugar: 'Oficina PEEP',
            responsables: 'Natalia Rivas - PEEP',
          },
          {
            hora: '1:10 pm a 4:15 pm',
            actividad: 'Charla sobre prevención del suicidio, por hora de clase',
            asisten: 'Grupos de grado séptimo y el docente de la hora',
            lugar: 'Aulas de clase',
            responsables: 'Natalia Rivas - PEEP',
          },
          {
            hora: '1:30 pm a 3:15 pm',
            actividad: 'COMFAMA: Inspiración Experiencias',
            asisten: 'Estudiantes y docente del grupo 3º1',
            lugar: 'Aula de clase, sede Gustavo Rodas',
            responsables: 'COMFAMA y Cosmo Schools',
          },
          {
            hora: '3:45 pm a 5:30 pm',
            actividad: 'COMFAMA: Inspiración Experiencias',
            asisten: 'Estudiantes y docente del grupo 3º2',
            lugar: 'Aula de clase, sede Gustavo Rodas',
            responsables: 'COMFAMA y Cosmo Schools',
          },
          {
            hora: '9:00 am',
            actividad: 'Asesoría a padres de familia o acudientes',
            asisten: 'Milena Badel',
            lugar: 'Sede Finca',
            responsables: 'Programa UAI',
          },
          {
            hora: '1:00 pm',
            actividad: 'Asesoría al docente de Ciencias Sociales',
            asisten: 'Ebigildo Chanapicama',
            lugar: 'Sede principal',
            responsables: 'Programa UAI',
          },
          {
      ...
      },
      {
        ...
        actividades: [
          {
            hora: '6:00 am a 12:00 m',
            actividad: 'Recuperación de aprendizajes',
            asisten: 'Estudiantes priorizados',
            lugar: 'Sede principal',
            responsables: 'Yuri Catalina Gómez, tutora PTA',
          },
          {
            hora: '7:00 am a 12:30 pm',
            actividad: 'III Convención de IE Inteligentes',
            asisten: 'Juan Carlos Blandón, Janneth Ocampo y estudiantes invitados',
            lugar: 'MOVA',
            responsables: 'SED',
          },
          {
            ...
            actividad: 'Comité operativo del Núcleo 937',
            asisten: 'Rectora',
            lugar: 'Comfama La Estrella',
            responsables: 'Jefe de núcleo',
          },
          {
          ...
          },
          {
            hora: '10:00 am a 11:40 am',
            actividad: 'Taller literario',
            asisten: 'Grupo 2°2 y su directora de grupo, Jaqueline Arévalo',
            lugar: 'Aula de clase',
            responsables: 'Asesor del Parque Biblioteca y Jaqueline Arévalo',
          },
          {
            hora: '10:00 am a 4:00 pm',
            actividad: 'Acompañamiento en aula y a docentes en centros de interés',
            asisten: 'Docentes y estudiantes',
            lugar: 'Sede Gustavo Rodas',
            responsables: 'Beatriz Marín M., tutora PTA',
          },
          {
            hora: '11:00 am a 12:30 pm',
            actividad: 'Reunión de macroproyectos: diseño de las actividades del segundo semestre',
            asisten: 'Integrantes de los macroproyectos',
            lugar: 'Sede principal',
            responsables: 'Líder de los macroproyectos',
          },
          {
            hora: '11:00 am',
            actividad: 'Asesoría a padres de familia o acudientes',
          ...
          },
          {
            ...
            actividad: 'Programa de higiene bucal: aplicación de flúor, en el orden 3º1 y 3º2',
            asisten: 'Grupos 3º1 y 3º2',
            lugar: 'Aulas de clase y cancha, sede Gustavo Rodas',
            responsables: 'Medellín te quiere saludable',
          },
          {
            hora: '1:10 pm a 3:30 pm',
            actividad: 'Charla sobre prevención del suicidio, por hora de clase',
            asisten: 'Grupos de grado octavo y el docente de la hora',
            lugar: 'Aulas de clase',
            responsables: 'Natalia Rivas - PEEP',
          },
          {
            hora: '1:30 pm a 3:15 pm',
            actividad: 'COMFAMA: Inspiración Experiencias',
            asisten: 'Estudiantes y docente del grupo 4º1',
            lugar: 'Aula de clase, sede Gustavo Rodas',
            responsables: 'COMFAMA y Cosmo Schools',
          },
          {
            hora: '3:45 pm a 5:30 pm',
            actividad: 'COMFAMA: Inspiración Experiencias',
            asisten: 'Estudiantes y docente del grupo 4º2',
            lugar: 'Aula de clase, sede Gustavo Rodas',
            responsables: 'COMFAMA y Cosmo Schools',
          },
          {
            hora: '2.ª y 3.ª hora',
            actividad: 'Taller de prevención de sustancias adictivas',
            asisten: 'Grupos de grado quinto',
            lugar: 'Salón de clase, sede Gustavo Rodas',
            responsables: 'Alexander Sánchez G.',
          },
          {
            hora: 'Durante la jornada',
            actividad: 'Asesorías en la IE San José Obrero',
            asisten: 'Ebigildo Chanapicama',
            lugar: 'IE San José Obrero',
            responsables: 'Programa UAI',
          },
        ],
      },
        ...
        actividades: [
          {
            ...
            actividad: 'Acompañamiento en aula: preescolar',
            asisten: 'Docentes y estudiantes de preescolar',
            lugar: 'Sede Gustavo Rodas',
            responsables: 'Beatriz Marín M., tutora PTA',
          },
          {
            hora: '8:00 am a 12:00 m',
            actividad: 'II mesa pública del PAE',
            asisten: 'Edwin Toro',
            lugar: 'MOVA',
            responsables: 'PAE',
          },
          {
            hora: '8:10 am a 10:00 am',
            actividad: 'Formación a líderes escolares, representantes de grupo y mediadores',
            asisten: 'Estudiantes de 9°, 10° y 11°',
            lugar: 'Sede principal',
            responsables: 'Paola Portela y Natalia Rivas - PEEP',
          },
          {
            hora: '10:00 am a 12:00 m',
            actividad: 'Lectura institucional',
            asisten: 'Equipo PEEP',
            lugar: 'Sede Casa Finca',
            responsables: 'PEEP',
          },
          {
            hora: '10:40 am a 3:00 pm',
            actividad: 'Programa de higiene bucal: aplicación de flúor, en el orden 4º1, 4º2, TSº1 y TSº2',
            asisten: 'Grupos 4º1, 4º2, TSº1 y TSº2',
            lugar: 'Aulas de clase y cancha, sede Gustavo Rodas',
            responsables: 'Medellín te quiere saludable',
          },
          {
          ...
          },
          {
            hora: '1:30 pm a 3:15 pm',
            actividad: 'COMFAMA: Inspiración Experiencias',
            asisten: 'Estudiantes y docente del grupo 5º1',
            lugar: 'Aula de clase, sede Gustavo Rodas',
            responsables: 'COMFAMA y Cosmo Schools',
          },
          {
            hora: '3:45 pm a 5:30 pm',
            actividad: 'COMFAMA: Inspiración Experiencias',
            asisten: 'Estudiantes y docente del grupo 5º2',
            lugar: 'Aula de clase, sede Gustavo Rodas',
            responsables: 'COMFAMA y Cosmo Schools',
          },
          {
            hora: 'Durante la jornada',
            actividad: 'Apoyo en aula: 7°3',
            asisten: 'Ebigildo Chanapicama',
            lugar: 'Sede principal',
            responsables: 'Programa UAI',
          },
      ...
      },
      {
        ...
        actividades: [
          {
            hora: '1 hora (las clases se dan con horario recortado)',
            actividad: 'Dirección de grupo en cada sede y jornada',
            asisten: 'Estudiantes de cada grupo con su director',
            lugar: 'Aulas de clase',
            responsables: 'Directores de grupo',
          },
          {
            hora: '6:30 am a 12:30 pm',
            actividad: 'Acompañamiento en aula',
            asisten: 'Docentes y estudiantes priorizados',
            lugar: 'Sede Gustavo Rodas',
            responsables: 'Beatriz Marín M., tutora PTA',
          },
          {
            hora: '7:00 am a 1:00 pm',
            actividad: 'Visita a la Feria del Libro',
            asisten: 'Grupos 10°2 y 2°3, con Beatriz Montoya y Mary Luz Hoyos',
          ...
          },
          {
            ...
            actividad: 'Acción educativa de autocuidado',
            asisten: 'Grupos 2°1 y 2°2',
            lugar: 'Aula, sede Gustavo Rodas',
            responsables: 'Natalia Rivas - PEEP',
          },
          {
            hora: '9:00 am a 3:00 pm',
            actividad: 'Acompañamiento en aula y elaboración de informes',
            asisten: 'Docentes y estudiantes',
            lugar: 'Sede principal',
            responsables: 'Yuri Catalina Gómez, tutora PTA',
          },
          {
            hora: '10:00 am',
            actividad: 'Formación a docentes en la IE Fe y Alegría La Cima',
            asisten: 'Ebigildo Chanapicama',
            lugar: 'IE Fe y Alegría La Cima',
            responsables: 'Programa UAI',
          },
          {
            hora: '10:00 am a 1:00 pm',
            actividad: 'Asesoría a estudiante y familia',
            asisten: 'Estudiante y familia citados',
            lugar: 'Sede Gustavo Rodas',
            responsables: 'Natalia Rivas - PEEP',
          },
          {
            hora: '12:30 pm a 2:00 pm',
            actividad: 'Programa de higiene bucal: aplicación de flúor, en el orden 5º1 y 5º2',
            asisten: 'Grupos 5º1 y 5º2',
            lugar: 'Aulas de clase y cancha',
            responsables: 'Medellín te quiere saludable',
          },
          {
            hora: '1:30 pm a 3:15 pm',
            actividad: 'COMFAMA: Inspiración Experiencias',
            asisten: 'Estudiantes y docentes de los grupos 3º3 y 4º3',
            lugar: 'Aula de clase, sede Finca',
            responsables: 'COMFAMA y Cosmo Schools',
          },
          {
            hora: '2.ª hora',
            actividad: 'Taller de prevención de sustancias adictivas',
            asisten: 'Grupos de grado quinto',
            lugar: 'Salón de clase, sede Finca',
            responsables: 'Alexander Sánchez G.',
          },
          {
            hora: '3:45 pm a 5:30 pm',
            actividad: 'COMFAMA: Inspiración Experiencias',
            asisten: 'Estudiantes y docente del grupo 5º3',
            lugar: 'Aula de clase, sede Finca',
            responsables: 'COMFAMA y Cosmo Schools',
          },
        ],
