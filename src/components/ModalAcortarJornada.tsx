      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="w-full max-w-xl bg-gray-950 border border-white/10 rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[92vh]"
          ...
          >
            <div className="px-6 pt-5 pb-4 border-b border-white/8 flex items-center justify-between">
              ...
              <button onClick={reset} className="text-gray-500 hover:text-white text-lg leading-none p-1" aria-label="Cerrar">✕</button>
            </div>
              ...
              {!guardado ? (
                <>
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-gray-900 text-white rounded-xl px-3 py-2.5 text-sm border border-white/10 focus:outline-none focus:border-amber-500"
                    />
                    <div className="text-xs text-gray-500 mt-1">{formatearFechaLegible(fecha)}</div>
                    {!esDiaLectivo && (
                  ...
                  <div>
                    <label className="block text-xs text-gray-400 mb-1.5">Hora en que termina la jornada hoy</label>
                    <input
                      type="time"
                      value={horaFin}
                  ...
                  <div>
                    ...
                    {motivo === 'Otro' && (
                      <input
                        ...
                        className="mt-2 w-full bg-gray-900 text-white rounded-xl px-3 py-2 text-sm border border-white/10 focus:outline-none focus:border-amber-500"
                      />
                    )}
                  </div>
                        ...
                        <tbody>
                          {bloques.map(b => (
                            <tr key={b.id} className="border-b border-white/6 last:border-b-0">
                              <td className="py-1.5 text-gray-400 w-24">{horaOrdinal(b.id)} hora</td>
                              <td className="py-1.5 font-semibold text-white tabular-nums">{b.inicio} – {b.fin}</td>
                              <td className="py-1.5 text-gray-500 text-right tabular-nums">
                                {(() => {
                          ...
                          <tr><td colSpan={3} className="pt-2 text-[10px] text-gray-600">
                ...
                <>
                  ...
                  <button
                    ...
                    className="w-full px-4 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-sm font-semibold transition"
                  >
            ...
            <div className="px-6 py-4 border-t border-white/8 bg-gray-950/80 flex justify-end gap-3">
              {!guardado ? (
                <>
                  <button onClick={reset} className="px-4 py-2.5 rounded-xl bg-white/6 hover:bg-white/12 text-gray-300 text-sm transition">
                    Cancelar
                  </button>
                  <button
                    onClick={guardar}
                    ...
                    className={cn(
                      'px-5 py-2.5 rounded-xl text-white text-sm font-semibold transition',
